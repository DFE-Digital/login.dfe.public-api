...
const getUsersOrganisationsAndServices = async (req, res) => {
  ...
  try {
    ...
    // Call to get data about user of this service (limited by clientId). Returns their role for this
    ...
    // Get list of ALL services for the user.  We need this because it has all the the policy roles
    // (I think that's what they're called) for the user against each service for each organisationId.
    ...
    console.log(servicesForAUser[1].roles);
