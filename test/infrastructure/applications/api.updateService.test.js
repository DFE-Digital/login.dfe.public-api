...
const { updateService } = require('../../../src/infrastructure/applications/api');
...
describe('when getting a users services mapping from api', () => {
  ...
  it('then it should call users resource with user id', async () => {
    await updateService(serviceId, patchedProperties, correlationId);
  ...
  it('should return false on a 404 response', async () => {
    ...
    const result = await updateService(serviceId, patchedProperties, correlationId);
